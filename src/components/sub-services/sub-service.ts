...
import daluationImage from '/images/transaction-deals/Valuation Services.png';
import dinancialImage from '/images/assurance/Financial.png';
import dorensicImage from '/images/assurance/Forensic.png';
