...
export const advisoryService: CardProps[] = [
    {
        image: images.BusinessConsultingImage,
        title: Advisory.BC,
    ...
    {
        image: images.StrategicConsultingImage,
        title: Advisory.SC,
...
export const transactionDealsService: CardProps[] = [
    ...
    {
        image: images.DueDiligenceImage,
