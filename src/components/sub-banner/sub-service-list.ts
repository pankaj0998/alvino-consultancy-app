...
import taxBannerImage from '/images/tax-banner.png'
import transactionBannerImage from '/images/transaction-banner.jpg'
import assuranceBannerImage from '/images/assurance-banner.jpg'

const imageList = {
    subBannerImage: subBannerImage,
    linerImage: linerImage,
    taxBannerImage: taxBannerImage,
    transactionBannerImage: transactionBannerImage,
    assuranceBannerImage: assuranceBannerImage
}
export const taxAndRegulatory: SubBannerTypeProps = {
    ...
    backgroundImage: imageList.taxBannerImage,
...
export const transactionAndDeals: SubBannerTypeProps = {
    ...
    backgroundImage: imageList.transactionBannerImage,
    linerImageUrl: imageList.linerImage
}
...
export const assurance: SubBannerTypeProps = {
    ...
    backgroundImage: imageList.assuranceBannerImage,
    linerImageUrl: imageList.linerImage
}